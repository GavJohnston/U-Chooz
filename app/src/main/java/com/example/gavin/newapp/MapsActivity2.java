    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_subway2:
                ...
                String url = getUrl(latitude, longitude, subway_station);
                dataTransfer[0] = mMap;
                dataTransfer[1] = url;

                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby subway stations", Toast.LENGTH_SHORT).show();
                break;

            case R.id.B_restaurant2:
                mMap.clear();
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby parking", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_bars2:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby bars", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_taxi_stand2:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby taxi ranks", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_bus2:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby bus stations", Toast.LENGTH_SHORT).show();
                break;

            case R.id.B_train_station2:
                mMap.clear();
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby train stations", Toast.LENGTH_SHORT).show();
                break;
            case R.id.B_parking2:
                mMap.clear();
            ...
            case R.id.B_takeaway2:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby takeaways", Toast.LENGTH_SHORT).show();
                break;

            case R.id.B_delivery2:
                mMap.clear();
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby deliveries", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_grocery2:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity2.this, "Showing Nearby grocery/supermarkets", Toast.LENGTH_SHORT).show();
                break;
